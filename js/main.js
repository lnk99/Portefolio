...
const translations = {
  fr: {
    ...
    'hero.desc':'Ingénieur spécialisé en <strong>sûreté de fonctionnement</strong> et <strong>Data Science</strong>, j\'interviens sur des systèmes critiques — automobile, médical, ferroviaire. Actuellement alternant chez <strong>Valeo</strong> et diplomé de <strong>Polytech Angers</strong> avec un <strong>Master en Data Science (USA)</strong>, j\'associe analyses de fiabilité, conformité normative (ISO\u00a026262, EN\u00a050126) et modélisation prédictive pour concevoir des systèmes dont la défaillance n\'est pas une option.',
  ...
  en: {
    ...
    'hero.desc':'Engineer specializing in <strong>functional safety</strong> and <strong>Data Science</strong>, working on critical systems — automotive, medical, railway. Currently an apprentice at <strong>Valeo</strong> and a graduate of <strong>Polytech Angers</strong> with a <strong>Master\'s in Data Science (USA)</strong>, I combine reliability analyses, standards compliance (ISO\u00a026262, EN\u00a050126) and predictive modeling to design systems where failure is not an option.',
