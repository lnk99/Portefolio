...
const translations = {
  fr: {
    ...
    'hero.desc':'Alternant en Sûreté de Fonctionnement chez <strong>Valeo</strong>, futur diplomé de <strong>Polytech Angers</strong> et titulaire d\'un <strong>Master en Data Science (USA)</strong>, je suis activement à la recherche d\'un <strong>CDI dès septembre 2026</strong>. Mon double profil sûreté & Data Science me permet d\'apporter un regard neuf sur la fiabilité des systèmes critiques.',
    ...
    'about.p1':"Rigoureux, autonome et à l'aise dans des <strong>environnements internationaux</strong>, mes expériences professionnelles m'ont permis de consolider mon <em>background</em> en sûreté de fonctionnement. Aujourd'hui, je suis en transition professionnelle et ouvert à de nouvelles opportunités, notamment dans <strong>l'automobile, le ferroviaire ou les systèmes industriels complexes</strong>, où je souhaite mettre ma double compétence technique et analytique au service de <strong>projets innovants et à fort impact</strong>.",
    ...
    'about.p2':"Alternant chez <strong>Valeo</strong>, je contribue quotidiennement à la sûreté des systèmes embarqués ADAS de prochaine génération. Ma formation à <strong>Polytech Angers</strong> (ingénierie des systèmes complexes) complétée d'un <strong>Master Data Science aux États-Unis</strong> me donne un profil que peu d'ingénieurs possèdent : analyser la fiabilité <em>et</em> la modéliser intelligemment.",
    'about.p3':"J'ai déjà œuvré dans <strong>l'automobile, le médical, la robotique chirurgicale et la qualité industrielle</strong>, autant de secteurs où chaque défaillance compte et où la rigueur technique est non négociable.",
    ...
    'exp.valeo.role':'Alternant Ingénieur Innovation de la Sûreté de Fonctionnement',
    ...
    'exp.valeo.b2':'Évaluation de la conformité <strong>ASIL B</strong> d’un module SEooC du middleware open source (<strong>Eclipse S-CORE</strong>)',
    ...
    'skill.python':'Python, R, SAS, SQL','skill.ml':'ML (scikit-learn, supervisé / non-sup.)','skill.dl':'Deep Learning (PyTorch, TensorFlow)',
    'skill.huggingface':'HuggingFace / Transformers',
    'skill.ts':'Séries Temporelles','skill.rsql':'Python, R, SAS, SQL',
    ...
    'skill.mlflow':'MLflow (tracking, versioning)','skill.docker':'Docker / FastAPI','skill.langchain':'LangChain / RAG (LLM apps)',
  ...
  en: {
    ...
    'hero.desc':'Functional Safety Apprentice at <strong>Valeo</strong>, future graduate of <strong>Polytech Angers</strong> and holder of a <strong>Master\'s in Data Science (USA)</strong>, I am actively seeking a <strong>full-time position starting September 2026</strong>. My dual profile in safety & Data Science brings a fresh perspective to the reliability of critical systems.',
    ...
    'about.p1':'Rigorous, autonomous and comfortable in <strong>international environments</strong>, my professional experiences have allowed me to build a strong <em>background</em> in functional safety. Currently in professional transition, I am open to new opportunities, particularly in <strong>automotive, railway or complex industrial systems</strong>, where I wish to put my dual technical and analytical expertise at the service of <strong>innovative, high-impact projects</strong>.',
    ...
    'about.p2':"As an apprentice at <strong>Valeo</strong>, I contribute daily to the safety of next-generation ADAS embedded systems. My training at <strong>Polytech Angers</strong> (complex systems engineering) complemented by a <strong>Master's in Data Science in the United States</strong> gives me a profile few engineers possess: analyzing reliability <em>and</em> modeling it intelligently.",
    'about.p3':'I have already worked in <strong>automotive, medical, surgical robotics and industrial quality</strong>, fields where every failure matters and where technical rigor is non-negotiable.',
    ...
    'exp.valeo.role':'Engineering Apprentice | Functional Safety Innovation',
    ...
    'exp.valeo.b2':'<strong>ASIL B</strong> compliance assessment of a SEooC module from the open-source middleware (<strong>Eclipse S-CORE</strong>)',
    ...
    'skill.python':'Python, R, SAS, SQL','skill.ml':'ML (scikit-learn, supervised / unsup.)','skill.dl':'Deep Learning (PyTorch, TensorFlow)',
    'skill.huggingface':'HuggingFace / Transformers',
    'skill.ts':'Time Series','skill.rsql':'Python, R, SAS, SQL',
