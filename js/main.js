...
const translations = {
  fr: {
    ...
    'hero.desc':'Alternant Ingénieur Innovation de la Sûreté de Fonctionnement chez <strong>Valeo</strong>, futur diplomé de <strong>Polytech Angers</strong> et titulaire d\'un <strong>Master en Data Science (USA)</strong>, je suis activement à la recherche d\'un <strong>CDI dès septembre 2026</strong>. Mon double profil sûreté & Data Science me permet d\'apporter un regard neuf sur la fiabilité des systèmes critiques.',
