...
const translations = {
  fr: {
    ...
    'skill.python':'Python','skill.ml':'ML (scikit-learn, supervisé / non-sup.)','skill.dl':'Deep Learning (PyTorch, TensorFlow)',
  ...
  en: {
    ...
    'skill.python':'Python','skill.ml':'ML (scikit-learn, supervised / unsup.)','skill.dl':'Deep Learning (PyTorch, TensorFlow)',
    'skill.huggingface':'HuggingFace / Transformers',
