...
const translations = {
  fr: {
    ...
    'about.p1':"Rigoureux, autonome et à l'aise dans des <strong>environnements internationaux</strong>, je me situe à l'intersection de la <strong>sûreté de fonctionnement</strong> et de la <strong>Data Science</strong>. Mes expériences professionnelles m'ont permis de consolider un solide <em>background</em> en safety sur des systèmes critiques.",
  ...
  en: {
    ...
    'about.p1':'Rigorous, autonomous and comfortable in <strong>international environments</strong>, I stand at the intersection of <strong>functional safety</strong> and <strong>Data Science</strong>. My professional experiences have allowed me to build a strong <em>background</em> in safety on critical systems.',
    ...
    'about.p3':'I have already worked in <strong>automotive, medical, surgical robotics and industrial quality</strong>. Currently in professional transition, I am open to new opportunities — particularly in <strong>automotive, railway or complex industrial systems</strong> — where I wish to put my dual technical and analytical expertise at the service of <strong>innovative, high-impact projects</strong>.',
